...
const CaseDetail: React.FC = props => {
  ...
  return <div className="case-detail">
    <div className="card business-card">
      <img className="img" src="https://joeschmoe.io/api/v1/random" alt="" />
      <div className="business-info">
        <h1 className="business-name">{store.dataS?.currentCase?.name || '门店'}</h1>
    ...
    <div className="card" ref={ref}>
      ...
      <p>
        ...
        位置：双流1号线华府大道往前走一百多米蓝润四楼
      </p>
      <p>

        面积：大概有30张桌子左右 室内100平左右 室外250平左右
      </p>
      <p>
        营销：合作再惠会员系统2年，合作前有做过一些抖音 笔记 小红书的推广，在和再惠合作之前点评运营是请的独立个人运营。
      </p>
      ...
      <p>
        张城（城哥/外貌瘦瘦高高的/主要负责营销板块） 周杰灵 （周哥/外貌微胖/西昌人）
      </p>
    ...
    <div className="card">
      ...
      <h3>
        2：营销点提炼（为了提升门店点击率转化率）
      </h3>
      <h4>
        ①入口图
      </h4>
      <p>
        3月合作前原本使用羊肉汤，点击率8.81→合作后第一版图：有烟火的100%原碳烤，点击率↑8.92→第二版图：小龙虾，点击率↑9.76 →第三版图：天台烧烤，点击率↑10.53→第四版图：绝美天台，点击率↑10.87
      </p>
      ...
      <p>
        3月合作前原本使用天台夜景→合作后第一版：100%原碳烤看得见的烟与火→第二版：天台风景图→第三版：绝美天台 （曝光不断增加，购买转化保持在2.8左右，但购买人数从刚开始的单月69人提升到单月450人左右）
      </p>
